...
(function ($) {
	...
	var retinaLogos = function () {
		...
		if (retina) {
			$("#header .logo")
				.find("img")
				.attr({ src: "assets/images/AUTORESERVE-PNG.png" });
			$("#Footer .widget-info")
				.find("img")
				.attr({ src: "assets/images/logo/logo-footer@2x.png" });
		}
	};
			...
			switch (type) {
				case "grid":
					$(".listing-list-car-wrap")
						.find(".listing-list-car-grid")
						.removeClass("listing-list-car-list");
				...
				case "list":
					$(".listing-list-car-wrap")
						.find(".listing-list-car-grid")
						.addClass("listing-list-car-list");

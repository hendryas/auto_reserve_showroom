<body data-bs-spy="scroll" data-bs-target="#navbar-navlist" data-bs-offset="60">
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top sticky">
        <div class="container">
            <a class="navbar-brand" href="<?php echo site_url() ?>"><img src="<?php echo base_url(); ?>assets/images/AUTORESERVE-PNG.png" alt="" height="55" width="55" style='border-radius: 10px 10px 10px 10px;'></a>

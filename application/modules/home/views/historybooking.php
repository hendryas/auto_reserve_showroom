            ...
            <main id="main-content" class="site-main-dashboard">
                <div class="page-dashboard-wrap">
                    <div class="dashboard">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="title-dashboard">History Booking</h4>
                            </div>
                        ...
                        <div class="table-listing-inventory">
                            <table class="listing-inventory">
                                <?php if (count($historyBookingMobil) != 0) : ?>
                                    <tbody>
                                        <?php foreach ($historyBookingMobil as $data) : ?>
                                            <tr>
                                                <td>
                                                    <div class="tfcl-listing-listing">
                                                        ...
                                                        <div class="listing-summary">
                                                            ...
                                                            <div class="price">
                                                                Harga Cash :
                                                                <br>
                                                                Rp <?php echo number_format($data['harga_cash'], 0) ?>
                                                            </div>
                                                            <div class="price mt-3">
                                                                Harga Credit :
                                                                <br>
                                                                Rp <?php echo number_format($data['harga_credit'], 0) ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>

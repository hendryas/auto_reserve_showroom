...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jun 2024 pada 02.46
...
INSERT INTO `model_mobil` (`id_model_mobil`, `model`, `date_created`, `date_updated`, `delete_sts`) VALUES
(1, 'Daihatsu Xenia', '2024-05-23 16:24:54', '2024-05-23 16:25:02', 0),
(2, 'Daihatsu Ayla', '2024-05-23 16:26:18', NULL, 0);
...
INSERT INTO `variant_mobil` (`id_variant_mobil`, `variant_mobil`, `date_created`, `date_updated`, `delete_sts`) VALUES
(1, 'Avanza 1.3 E', '2024-05-23 16:38:29', '2024-05-23 16:39:10', 0);
...
--
ALTER TABLE `model_mobil`
  MODIFY `id_model_mobil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `variant_mobil`
  MODIFY `id_variant_mobil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
